...
const ViewTicket = () => {
    ...
    */
    ...
    const fetchTicketDetails = async () => {
        ...
        try {
            const response = await fetch(`${apiRoutes.viewTicket}/${ticket_id}`, {
                method: "GET",
                headers: {
    ...
    const processTicketResponse = async(e) => {
        ...
        try {
            const response = await fetch(apiRoutes.replyToTicket, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
            ...
            <div className="m-1 row mb-3">
                ...
                <div className="col-7">
                    <div className="d-flex justify-content-end gap-10">
                        <a href="/support" className="btn btn-primary b-r-22">
                            Back
                        </a>
                    </div>
                </div>
                                    ...
                                    <div className="mt-4 border-top pt-3">
                                        ...
                                        <ul className="d-flex flex-wrap">
                                            {ticketData.messages[0].attachments.map((attachment, index) => (
                                                <li key={attachment.id || index} class="me-3 w-250">
                                                    <a 
